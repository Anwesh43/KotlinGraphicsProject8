package com.example.bentuparcjoinview
...
fun Canvas.drawBentUpArcJoin(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawBUAJNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawBentUpArcJoin(scale, w, h, paint)
}

class BentUpArcJoinView(ctx : Context) : View(ctx) {
    ...
    data class BentUpArcJoin(var i : Int) {

        private var curr : BUAJNode = BUAJNode(0)
