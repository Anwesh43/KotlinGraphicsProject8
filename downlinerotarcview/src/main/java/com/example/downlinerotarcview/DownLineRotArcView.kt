package com.example.downlinerotarcview
...
fun Canvas.drawDownLineRotArc(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawDLRANode(i : Int, scale : Float, paint : Paint) {
    ...
    drawDownLineRotArc(scale, w, h, paint)
}

class DownLineRotArcView(ctx : Context) : View(ctx) {
    ...
    data class DownLineRotArc(var i : Int) {
